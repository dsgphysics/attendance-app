let students = [
    { roll: 1, name: "AADEEP KUMAR MONDAL" },
{ roll: 2, name: "AAHANA KUNDU" },
{ roll: 3, name: "AASHRAYA PRAJAPATI" },
{ roll: 4, name: "ABHINABA PRAMANIK" },
{ roll: 5, name: "ABHINANDAN NASKAR" },
{ roll: 6, name: "ABHIRUP GANGULY" },
{ roll: 7, name: "ADITYA SARKAR" },
{ roll: 8, name: "ADRIJA NASKAR" },
{ roll: 9, name: "ADRITO ROY" },
{ roll: 10, name: "AKASH DEY" },
{ roll: 11, name: "ANIDYA MISHRA" },
{ roll: 12, name: "ANIKA ARIF" },
{ roll: 13, name: "ANKITA NAIYA" },
{ roll: 14, name: "ANURAG DEY" },
{ roll: 15, name: "ANUSKA DAS" },
{ roll: 16, name: "ANUSKA GHOSH" },
{ roll: 17, name: "ARSHIA DHAR" },
{ roll: 18, name: "ASHNARGHYA JANA" },
{ roll: 19, name: "BIHAAN MAJUMDER" },
{ roll: 20, name: "BISHWARUP ACHARJEE" },
{ roll: 21, name: "DEBMALLYO NASKAR" },
{ roll: 22, name: "DIBAKAR KUMAR" },
{ roll: 23, name: "DIVYANSHI SANTRA" },
{ roll: 24, name: "HRITAM BHATTACHARYA" },
{ roll: 25, name: "JUHI SARDAR" },
{ roll: 26, name: "PARTHIB DEY" },
{ roll: 27, name: "RAM PRASAD BANERJEE" },
{ roll: 28, name: "RISHAN BHATTACHARYA" },
{ roll: 29, name: "RIYANK GHOSH" },
{ roll: 30, name: "ROHAN SINHA" },
{ roll: 31, name: "ROUNAK DAS" },
{ roll: 32, name: "SAMRIDDHI MISHRA" },
{ roll: 33, name: "SAMRIDHA MAJUMDAR" },
{ roll: 34, name: "SAPTAK SINHA" },
{ roll: 35, name: "SENJUTI PATRA" },
{ roll: 36, name: "SHRINIKA CHAKRABORTY" },
{ roll: 37, name: "SHUVOJIT SEN" },
{ roll: 38, name: "SOUJANYA BHATTACHARYA" },
{ roll: 39, name: "SOUMYADEEP MAITI" },
{ roll: 40, name: "SOUMYAJIT MALLICK" },
{ roll: 41, name: "SOURISH SENGUPTA" },
{ roll: 42, name: "SRESTHA ROY" },
{ roll: 43, name: "SRIJA DAS" },
{ roll: 44, name: "SRIJAN MANDAL" },
{ roll: 45, name: "SUBHODEEP MONDAL" },
{ roll: 46, name: "TITHI DEBNATH" },
{ roll: 47, name: "TRIPARNA MANDAL" }
];
